<%@page import="com.report.pojo.Meeting"%>
			...
			<div class="nano-content">
				...
				<ul class="nav nav-main">
					...
					<li class="nav-active"><a
						href="meeting/findAllMeeting/meetingReport_teacher"> <i
			...
			<div class="col-xs-12">
				...
				<div class="panel-body">
					...
					<form id="meetingForm" class="form-horizontal form-bordered"
						method="post" action="meeting/updateMeeting/meetingReport_teacher">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<textarea class="form-control" rows="5" name="meetingContent">${meetingContent}</textarea>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<select multiple data-plugin-selectTwo
									...
									<c:forEach items="${meetingMember}" var="meetingMember">
										<option selected="selected" value="${meetingMember}">${meetingMember}</option>
									</c:forEach>
									<optgroup label="老师">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<select multiple data-plugin-selectTwo
									...
									<option selected="selected" value="${recorder}">${recorder}</option>
									<optgroup label="老师">
										<c:forEach items="${users}" var="roleDTOs">
											<c:if test="${roleDTOs.roleid != 1}">
												<c:if test="${roleDTOs.roleid==2}">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" id="inputDefault"
									name="otherMember" value="${otherMember}">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" id="inputDefault"
									name="createTime" value="${createDate}">
							</div>
						</div>
					</form>
