<%@page import="com.report.dto.GroupDTO"%>
				...
				<ul class="nav nav-main">
					...
					<li class="nav-parent"><a> <i class="fa fa-list-alt"
						...
						<ul class="nav nav-children">
							...
							<li class="nav-active"><a href="group/getGroupList">
									查看小组 </a></li>
						</ul></li>
					<li class="nav-parent"><a> <i class="fa fa-list-alt"
			...
			<div class="col-xs-12">
				...
				<div class="panel-body">
					...
					<form id="groupForm" class="form-horizontal form-bordered"
						method="post" action="group/updateGroup">
						<%
						...
						<div class="form-group">
							<label class="col-md-3 control-label">小组id</label>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<select multiple data-plugin-selectTwo
									...
									<c:forEach items="${leaders}" var="groupDTOsLeader">
										<option selected="selected"
											value="${groupDTOsLeader.leaderId}">${groupDTOsLeader.leaderName}</option>
									</c:forEach>

									<optgroup label="老师">
										<c:forEach items="${users}" var="roleDTOs">
											<c:if test="${roleDTOs.id != 1}">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<select multiple data-plugin-selectTwo
									...
									<c:forEach items="${members}" var="groupDTOsMember">
										<option selected="selected"
											value="${groupDTOsMember.memberId }">${groupDTOsMember.memberName}</option>
									</c:forEach>
									<c:forEach items="${users}" var="groupDTOs">
										<c:if test="${groupDTOs.id != 1}">
											<c:if test="${groupDTOs.roleid==3}">
												<option value="${groupDTOs.id}">${groupDTOs.name}</option>
											</c:if>
										</c:if>
									</c:forEach>
