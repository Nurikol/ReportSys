			...
			<div class="nano-content">
				...
				<ul class="nav nav-main">
					...
					<li class="nav-parent nav-expanded"><a> <i class="fa fa-list-alt"
						...
						<ul class="nav nav-children">
							<li class="nav-active"><a href="project/createProject"> 创建项目 </a></li>
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="panel-body">
					<form id="pf" class="form-horizontal form-bordered"
						action="project/addProject" method="post">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">项目小组</label>
							<div class="col-md-6">
								<select name="groupID" data-plugin-selecttwo=""
									class="form-control populate select2-offscreen" tabindex="-1"
									title="">
									<optgroup label="选择小组">
					...
					<footer class="panel-footer" style="margin-top:20px;background-color:white">
