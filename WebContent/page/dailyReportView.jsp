				...
				<ul class="nav nav-main">
					...
					<li class="nav-parent nav-expanded"><a> <i
						...
						<ul class="nav nav-children">
							<li class="nav-active"><a href="report/findAllDailyReport"> 日报表 </a></li>
					...
					<!-- start: page -->
						<div class="row">
							...
							<header class="panel-heading" style="background: #0088cc">
								...
								<h2 class="panel-title" style="color: #fdfdfd">日报列表</h2>
							</header>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default"  style="width: 100%" >
									<thead>
										<tr>
											...
											<th class="center" style="width:25%">日期</th>
											<th class="center" style="width:25%">用户</th>
											 <th class="center hide" style="width:15%">应提交日报数</th> 
											<th class="center" style="width:25%">查看</th>
											
											
										</tr>
									</thead>
									<tbody>
									<c:forEach items="${dailyreports}" var="DailyReportDTO">
										<tr class="gradeX center">
											<td>${DailyReportDTO.date}</td>
											<td>${DailyReportDTO.userName}</td>
											<td class="hide">${DailyReportDTO.projectName}</td>
											<td> <a  href="report/showDailyReportSingle/dailyReportViewSingle?dailyuName=${DailyReportDTO.userName}&dailypName=${DailyReportDTO.projectName}">
