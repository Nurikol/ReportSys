				...
				<ul class="nav nav-main">
					...
					<li class="nav-parent nav-expanded"><a> <i class="fa fa-list-alt"
						...
						<ul class="nav nav-children">
							...
							<li class="nav-active"><a href="group/getGroupList"> 查看小组 </a></li>
						</ul></li>
							...
							<tbody>
								...
								<c:forEach items="${groups}" var="group">
									<tr>
										...
										<td>${group.leader}</td>
										<td>${group.member}</td>
										<td class="actions-hover actions-fade"><a
											href="group/getUserListInUpdateGroup?groupName=${group.name}&groupId=${group.id}"><i
												class="fa fa-pencil"></i></a> <a
											href="group/deleteGroup?groupId=${group.id}"
