				...
				<ul class="nav nav-main">
					...
					<li class="nav-parent nav-expanded"><a> <i
						...
						<ul class="nav nav-children">
							...
							<li  class="nav-active"><a href="report/getReportCount"> 统计分析 </a></li>
						</ul></li>
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table class="table table-hover mb-none">
							...
							<tbody>
								<tr>
									<td class="center">周报表</td>
									<td>本周需提交周报表 ${ReportCount} 份，已提交${WeeklyReportCount}份</td>
								</tr>
								<tr>
									<td class="center">日报表</td>
									<td>今天需提交日报表 ${ReportCount} 份，已提交${DailyReportCount}份</td>
								</tr>
							</tbody>
						</table>
					</div>
						...
						<table class="table table-hover mb-none">
							<thead>
								<tr>
									...
									<th class="center">周报表</th>
								</tr>
							</thead>
							<tbody>
							<c:forEach items="${showusers}" var="UserDTO">
								<tr>
									<td class="center">${UserDTO.account}</td>
									<td class="center">${UserDTO.username}</td>
									<td class="center"><a href="statistics/dailyReportStatistics?suID=${UserDTO.id}&suN=${UserDTO.username}">日报表分析</a></td>
									<td class="center"><a href="statistics/weelyReportStatistics?suID=${UserDTO.id}&suN=${UserDTO.username}">周报表分析</a></td>
								</tr>
							</c:forEach>
								<!-- <tr>
									<td>15008365956</td>
									<td>周虹廷</td>
									<td><a href="dailyReportStatistics.html">日报表分析</a></td>
									<td><a href="weeklyReportStatistics.html">周报表分析</a></td>
								</tr> -->
							</tbody>
						</table>
					</div>
