				...
				<div class="col-md-6" style="width: 100%">
					<div class="tabs tabs-primary">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#sumbit-weeklypaper"
								data-toggle="tab">提交我的周报</a></li>
							<li><a href="#recent1" data-toggle="tab">查看我的周报</a></li>
						</ul>
						<div class="tab-content">
							<div id="sumbit-weeklypaper" class="tab-pane active">
								...
								<form id="weekForm" class="form-horizontal"
									...
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-2 control-label">历史遗留问题： </label>
											<div class="col-sm-10">
										...
										<div class="form-group">
											<label class="col-sm-2 control-label">本周进展：</label>
											<div class="col-sm-10">
												<textarea class="form-control" rows="5"
										...
										<div class="form-group">
											<label class="col-sm-2 control-label"
												style="text-align: center">存在问题及解决方案：</label>
											<div class="col-sm-10">
												<textarea class="form-control" rows="5"
										...
										<div class="form-group">
											<label class="col-sm-2 control-label"
												style="text-align: center">可能问题及解决方案：</label>
											<div class="col-sm-10">
												<textarea class="form-control" rows="5"
								...
								<button type="submit" onclick="addWeeklyReport()"
									class="btn btn-primary" style="margin-left: 45%">提交</button>
							...
							<div id="recent1" class="tab-pane">
								<form id="form1" class="form-horizontal">
									...
									<form id="form1" class="form-horizontal">
										...
										<div class="panel-body">
											<div class="form-group">
												<label class="col-sm-3 control-label">历史遗留问题： </label>
												<div class="col-sm-9">
													<p class="control-label" style="text-align: left">${wrProblem}</p>
												</div>
											</div>
											<hr>
											<div class="form-group">
												<label class="col-sm-3 control-label">本周进展：</label>
												<div class="col-sm-9">
													<p class="control-label" style="text-align: left">${wrSummary}</p>
												</div>
											</div>
											<hr>
											<div class="form-group">
												<label class="col-sm-3 control-label">存在问题及解决方案：</label>
												<div class="col-sm-9">
													<p class="control-label" style="text-align: left">${wrSolution}</p>
												</div>
											</div>
											<hr>
											<div class="form-group">
												<label class="col-sm-3 control-label">下周计划：</label>
												<div class="col-sm-9">
													<p class="control-label" style="text-align: left">${wrNextPlan}</p>
												</div>
											</div>
											<hr>
											<div class="form-group">
												<label class="col-sm-3 control-label">可能问题及解决方案：</label>
												<div class="col-sm-9">
													<p class="control-label" style="text-align: left">${wrFutureSolution}</p>
												</div>
											</div>
										</div>
										</section>
