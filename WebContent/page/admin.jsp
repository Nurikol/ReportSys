		...
		<div class="row">
			<div class="col-lg-12">
				<section class="panel panel-primary"> <header
					class="panel-heading"> <label class="panel-title">公告信息</label>
				<a href="page/createNotice.jsp" class="mb-xs mt-xs mr-xs btn btn-primary"
				...
				<div class="panel-body" style="height: 450px">
					...
					<c:forEach items="${notices}" var="notices">
						<blockquote class="primary">
							<p>${notices.content}
								<a href="notice/deleteNotice?id=${notices.id}"
									class="mb-xs mt-xs mr-xs btn btn-default"
									style="position: absolute; right: 80px; border: none;"> <i
