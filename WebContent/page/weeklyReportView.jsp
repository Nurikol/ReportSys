	...
	<div class="inner-wrapper">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<h2 class="panel-title" style="color: #fdfdfd">周报列表</h2>
				</header>
					...
					<table class="table table-bordered table-striped mb-none"
						...
						<thead>
							<tr>
								...
								<th class="center" style="width: 10%">用户</th>
								<th class="center" style="width: 10%">更新日期</th>
								<th class="center" style="width: 15%">项目</th>
								<th class="center" style="width: 10%">查看</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${Weeklyreports}" var="WeeklyReportDTO">
								<tr class="gradeX center">
									<td>${WeeklyReportDTO.userName}</td>
									<td>${WeeklyReportDTO.date}周</td>
									<td>${WeeklyReportDTO.projectName}</td>
									<td><a
										href="report/weeklyReportViewSingle?cuid=${WeeklyReportDTO.userID}&cpid=${WeeklyReportDTO.projectID}&n=0">
